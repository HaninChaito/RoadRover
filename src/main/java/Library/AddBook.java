...
public class AddBook implements IOOperation {
	...
	public void oper(Database database, User user) {
		...
		JLabel label4 = Main.label("Year Of Publication:");
		...
		JTextField year = Main.textfield();
		...
		addbook.addActionListener((ActionEvent e) -> {
                    ...
                    if (year.getText().toString().matches("")) {
                        JOptionPane.showMessageDialog(new JFrame(), "Year cannot be empty!");
                        return;
                    }
                    ...
                    if (database.getBook(name.getText().toString())>-1) {
                        ...
                        book.setYear(Integer.parseInt(year.getText().toString())); // Set the year
